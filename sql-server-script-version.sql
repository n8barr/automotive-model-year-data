...
(
	VehicleDefinitionId INT NOT NULL IDENTITY PRIMARY KEY,
	YearId INT  NOT NULL,
	MakeName VARCHAR(50) NULL,
	ModelName VARCHAR(50) NOT NULL
) 
GO
CREATE UNIQUE INDEX UIX_VehicleDefinition ON VehicleDefinition(YearId, MakeName, ModelName)
GO
CREATE INDEX IX_VehicleDefinition_YearId ON VehicleDefinition(YearId);
GO
CREATE INDEX IX_VehicleDefinition_MakeName ON VehicleDefinition(MakeName);
GO
CREATE INDEX IX_VehicleDefinition_ModelName ON VehicleDefinition(ModelName);
GO
INSERT INTO VehicleDefinition (YearId, MakeName, ModelName) VALUES 
(1909, 'Ford', 'Model T'),
